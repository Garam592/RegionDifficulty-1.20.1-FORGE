...
public class ModItems {
    ...
    public static final RegistryObject<Item> DIFFICULTY_INDICATOR= ITEMS.register("difficulty_indicator",
            () -> new DifficultyIndicatorItem(new Item.Properties().stacksTo(1)));
